...
import com.yupi.yunpicturebackend.service.SpaceAnalyzeService;
...
@Service
public class SpaceAnalyzeServicelmpl extends ServiceImpl<SpaceMapper, Space> implements SpaceAnalyzeService {
    @Resource
    ...
    private PictureService pictureService;
        ...
        public SpaceUsageAnalyzeResponse getSpaceUsageAnalyze(SpaceUsageAnalyzeRequest spaceUsageAnalyzeRequest, User loginUser) {
            ...
            if (spaceUsageAnalyzeRequest.isQueryAll() || spaceUsageAnalyzeRequest.isQueryPublic()) {
                ...
                //在查询全部空间或者公共图库时图片数量很多，只需要返回查询的特定的列就行，而不用返回picture对象，这样会大大节省资源
...
// 查询结果
    ...
    /**
     * 根据请求参数的值，自动填充MyBatisplus中的查询条件
     * @param spaceAnalyzeRequest
     * @param queryWrapper
     */
